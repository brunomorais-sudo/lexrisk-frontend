...
import { PjeCredentialsForm } from '@/components/settings/PjeCredentialsForm';
    ...
    <div>
      ...
      <Tabs defaultValue="perfil">
        <TabsList>
          ...
          <TabsTrigger value="pje">Credenciais PJe</TabsTrigger>
        ...
        <TabsContent value="pje" className="mt-6">
          <PjeCredentialsForm />
        </TabsContent>
